...
void main() async {
  ...
  /// features. Otherwise the service used to load the theme settings will trigger
  /// an exception FlutterError.
  ...
  // SettingsView.
  runApp(Diogenes(settingsController: settingsController));
}
